...
- Veröffentlichung: Dieser Planlauf wird ausschließlich als Dokumentationsänderung gezielt committed und auf `origin/main` gepusht; `ZIELBILD.md` bleibt unverändert.
