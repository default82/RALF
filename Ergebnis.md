...
- Veröffentlichung: Die Code-, Paket-, Test- und Dokumentationsänderungen werden nach den Repository-Prüfungen gezielt committed und auf `origin/main` gepusht; `secrets/` bleibt ungetrackt und unverändert.
