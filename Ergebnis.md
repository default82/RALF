...
- Veröffentlichung: Die Änderungen sind nach den Abschlussprüfungen für einen gezielten Commit und den festgelegten Git-/PR-Ablauf vorbereitet; `secrets/` bleibt ungetrackt und unverändert.
