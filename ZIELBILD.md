...
| M-030 | ABGESCHLOSSEN | Der reproduzierbare Host-/Gast-Deploymentpfad für das geprüfte Paket `ralf-bootstrap` ist mit SHA-256-geprüftem Bundle, temporärer Virtualenv, exakten Runtime-Pins, unprivilegiertem Systembenutzer, Zielverzeichnissen und gehärteter systemd-Unit für `127.0.0.1:8080` implementiert und gemockt getestet. Eine reale Installation in VMID 100 ist nicht erfolgt; Runtime-Abhängigkeiten besitzen noch keine Artefakt-Hashes. |
