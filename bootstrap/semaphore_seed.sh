...
all_infra_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"030-minio-lxc 020-postgres-lxc 034-gitea-lxc 040-semaphore-lxc 042-vaultwarden-lxc 044-n8n-lxc 046-dashy-lxc 090-exo-lxc 110-synapse-lxc 112-mail-lxc"}')"
all_apply_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"030-minio-lxc 031-minio-config 020-postgres-lxc 021-postgres-config 034-gitea-lxc 035-gitea-config 040-semaphore-lxc 041-semaphore-config 042-vaultwarden-lxc 043-vaultwarden-config 044-n8n-lxc 045-n8n-config 046-dashy-lxc 047-dashy-config 090-exo-lxc 091-exo-config 110-synapse-lxc 111-synapse-config 112-mail-lxc 113-mail-config"}')"
...
dashboard_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"046-dashy-lxc 047-dashy-config"}')"
...
dashboard_infra_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"046-dashy-lxc"}')"
dashboard_config_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"047-dashy-config"}')"
all_config_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"031-minio-config 021-postgres-config 035-gitea-config 041-semaphore-config 043-vaultwarden-config 045-n8n-config 047-dashy-config 111-synapse-config 113-mail-config 091-exo-config"}')"
...
dashy_only_env_json="$(jq -nc '{AUTO_APPLY:"1",START_AT:"000",ONLY_STACKS:"046-dashy-lxc 047-dashy-config"}')"
...
dashboard_env_id="$(ensure_env 'RALF Dashboard Env' "$dashboard_env_json")"
...
dashboard_infra_env_id="$(ensure_env 'RALF Dashboard Infra Env' "$dashboard_infra_env_json")"
dashboard_config_env_id="$(ensure_env 'RALF Dashboard Config Env' "$dashboard_config_env_json")"
...
dashy_only_env_id="$(ensure_env 'RALF Dashy Only Env' "$dashy_only_env_json")"
...
ensure_template "RALF Dashboard Apply" "/usr/local/bin/ralf-semaphore-run" "[]" "$dashboard_env_id"
...
ensure_template "RALF Dashboard Infra Apply" "/usr/local/bin/ralf-semaphore-run" "[]" "$dashboard_infra_env_id"
ensure_template "RALF Dashboard Config Apply" "/usr/local/bin/ralf-semaphore-run" "[]" "$dashboard_config_env_id"
...
ensure_template "RALF Dashy Apply" "/usr/local/bin/ralf-semaphore-run" "[]" "$dashy_only_env_id"
...
ensure_template "RALF Dashboard Smoke" "/usr/local/bin/ralf-semaphore-smoke" "[\"dashboard\"]" "$smoke_env_id"
