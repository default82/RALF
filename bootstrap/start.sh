...
RALF_DNS_MODE="$(prompt RALF_DNS_MODE 'DNS-Modus' 'internal-zone')"
RALF_DNS_ZONE="$(prompt RALF_DNS_ZONE 'Interne DNS-Zone' "$RALF_DOMAIN")"
RALF_NETWORK_CIDR="$(prompt RALF_NETWORK_CIDR 'RALF Netzwerk-CIDR' '10.10.0.0/16')"
RALF_DNS_RESOLVER="$(prompt RALF_DNS_RESOLVER 'Interner DNS-Resolver' '10.10.0.1')"
...
RALF_DNS_MODE="$RALF_DNS_MODE"
RALF_DNS_ZONE="$RALF_DNS_ZONE"
RALF_DNS_RESOLVER="$RALF_DNS_RESOLVER"
